...
pygame.display.set_caption("AtomSmash 8.1.6")
...
level_up_triggered = False  # Agregamos una variable para controlar si el mensaje de nivel ha sido mostrado
while running:
    ...
    if rocket_lives == 0:
        ...
        restart_text = score_font.render("Presiona Espacio Para volver a Jugar", True, green)
        screen.blit(restart_text,(screen_width // 2 - 200, screen_height // 2 + 345))
