...
pygame.display.set_caption("Metroid 1.3")
...
mini_speed = -5   # Velocidad mínima permitida de reversa
...
# Fuente para el menú
menu_name = pygame.font.Font(None, 32)
menu_txt = menu_name.render("Metiorid 1.3", True,green)

menu_font = pygame.font.Font(None, 64)
menu_text = menu_font.render("Play Game", True, green)
...
while menu:
    ...
    screen.fill(black)
    screen.blit(menu_text, (screen_width // 2 - 120, screen_height // 2))
    screen.blit(menu_txt, (screen_width // 2 - 240, screen_height-50))
    pygame.display.flip()
    clock.tick(60)
